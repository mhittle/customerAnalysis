...
customer_master <- stripe_clean %>%
  ...
  filter(total_spend > 0) %>%  # Only customers who actually purchased
...
All systems are joined on **email address** (lowercased, trimmed). Stripe serves as the master customer list. Zoho CRM provides the primary classification. BigCommerce provides fallback signals (shipping company, customer group) and order-level date data for yearly trend analysis.
